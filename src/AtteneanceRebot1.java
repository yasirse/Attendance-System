...
//System.out.println(FormatDate((new SimpleDateFormat("dd-MMM-yyyy")),"Jan 27, 2016"));
	...
	////////////////////////////////////////////////////		
		 String subject_test="atlc CS LIN 1/11/11 12/4/2015";
...
////////////////////////////////////////////////////////////////////
				...
				{
					 System.out.println("No department or campus selected");
					 System.exit(1);
				}
//////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////
	...
	if(!department)
	{
		...
		try{
			...
			{
				department=true;
				department_code = " and trim(lower(department_code)) like '"+department_code+"' ";
	...
	if(!designation)
	{
		...
		try{
			...
			while(resd.next())
			{
				...
				department_code = " and   designation_id ="+id+" ";
