...
public class CopyOfUpdateLeaveBalance {
	...
	public static void main(String args[]) {
		...
		if(subject_test.toLowerCase().contains("ulbe"))
		{
			...
			CopyOfUpdateLeaveBalance obj =new CopyOfUpdateLeaveBalance();
...
//////////////////////////////////////////////////////////////
	...
	try{
	String update_balance=" update iannual_leave_balance1 " +
	...
	//System.out.println( update_balance);
			...
			if(count1==1  )
			{
				...
				int count2=-1;
				try{
				String query_log="Insert into iannual_leave_balance_log (ID,IANNUAL_LEAVE_BALANCE_ID,CAMPUS_CODE,USER_ID,NOTE,DATE_CREATED,IP_ADDRESS,NOTIFIED) "+
				" values (26,"+balance_id+",'ISB','"+sender_email+"',' "+count_leave+",   Reference: '"+subject_test.replace("ulbe", "")+",sysdate,'email',-1)";
				  count2=orcl.DeleteUpdate(query_log);
				}catch (Exception ex){}
