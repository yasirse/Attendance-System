	       	 ...
	       	 /////////////////////////////////////////////////////////////////
			        ...
			        if(subject_test.toLowerCase().contains("nwdl"))
					{
						...
						if(ret[0]!=null && ret[0].equals("10"))
						{
							...
							processed=1;
							 SendEmail bn= new SendEmail(hr_email,hr_password,"noreply.hrisb@nu.edu.pk", "hr.isbcamp@nu.edu.pk",request_subject,table_data,true_message_id);
				       		  if( bn.Send(reply_to))
				    			 {
						...
						if(processed ==0)
						{
						   SendEmail bn= new SendEmail(hr_email,hr_password,"noreply.hrisb@nu.edu.pk", "slateisb@nu.edu.pk",request_subject,table_data,true_message_id);
			       		  if( bn.Send(reply_to))
			    			 {
			    				 System.out.println("Problem intimation sent to "+reply_to);
			    			 }
			       		     MarkRead(true_message_id);
						}
			        ...
			        else if(subject_test.toLowerCase().contains("ulbe")   )
					{
						String log_problem="";
						...
						if(ret[0]!=null && ret[0].equals("10"))
						{
							...
							//mark read
				       		     ...
				       		     SendEmail bn= new SendEmail(hr_email,hr_password,"noreply.hrisb@nu.edu.pk", null,request_subject,body,true_message_id);
				       		  if( bn.Send(reply_to))
				    			 {
				    				 System.out.println("Intimation sent to "+reply_to);
				    			 }
						...
						else
						{
							...
							//mark read
							 SendEmail bn= new SendEmail(hr_email,hr_password,"noreply.hrisb@nu.edu.pk", "slateisb@nu.edu.pk",request_subject,body,true_message_id);
				       		  if( bn.Send(reply_to))
				    			 {
				    				 System.out.println("Intimation sent to "+reply_to);
				    			 }
