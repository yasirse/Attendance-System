...
public class AtteneanceRebot_old {
			        ...
			        if(subject_test!=null &&  subject_test.toLowerCase().contains("campus"))
			        {
		        	 ...
		        	 try {
		    			...
		    			while(rs.next())
		    			{
		    				 ...
		    				 if((subject_test.contains("range")) && range==3)//////////range report start here
								{
		    					 ...
		    					 tab +="Attendance Report from  "+attendance_duration+"<br><br>" +department_title  ;
		    					 

		    				String jumbo_query="	 select istaff.user_id, istaff.title person_name, istaff.emp2, idesignation.title designation,  "+ 
		    				...
		    				"	 	 single_entry,absent, ROWD, TOWD, leave,NWD,presenceOWD,presenceNWD, presenceOWD +presenceNWD tpresence , NWD+TOWD TD, avg_in, avg_out  "+ 
		    				...
		    				"	 	 (  sum( (to_number(to_char(oto,'sssss')) - to_number(to_char(ofrom,'sssss')))/60/60  ) -  "+ 
		    				"	 	    (  "+ 
		    				...
		    				"	 order by tmrh_thershold_missing desc  ";
				    		 ...
				    		 ResultSet rse=  orcl.select(jumbo_query );
				    	   	tab +=" <table border='1'><tr><td>#</td><td>Name</td><td>EMP</td><td>Designation</td>" +
...
if(range==1 && subject_test.toLowerCase().contains("report1"))
{
	...
	subject_test=subject_test.toLowerCase().replace("report1", "");
				...
				try {
					String qur1="";
					 qur1="select user_id,title, designation_id, dept_id,section_id,emp2,email from istaff where trim(lower(email)) like '"+email.toLowerCase().trim()+"' and campus_id like 'ISB' ";
					...
					if(subject_test.contains("department"))
					{
						...
						if(isdepartment_query)
							qur1="select user_id,title, designation_id, dept_id,section_id,emp2,email from istaff where trim(upper(dept_id)) like '"+required_department+"' and campus_id like 'ISB'  and current_status=1 order by designation_id, title";
						else
						{
